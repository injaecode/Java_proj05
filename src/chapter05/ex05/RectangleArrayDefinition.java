...
public class RectangleArrayDefinition {
	...
	public static void main(String[] args) {
		// 다차원 배열(2차원 배열)
		//	- 정방형 배열 : 행(row)에 대해서 열(column, field)이 동일한 배열 
		//	- 비정방형 배열: 행(row)에 대해서 열(column, field)이 동일하지 않은 배열 
		...
		int [][] arr1 = new int[3][4] ; //3: 행의 갯수(0, 1, 2) 
			...
			//4. 정방형 배열 선언과 동시에 값 입력 <주의> 방 크기 지정 시 오류 발생
			System.out.println("===============");
			...
			//5. 정방형 배열 선언과 동시에 값 입력 2 : 선언/값을 분리할 수 없다.
			int[][] arr13 = {{100,110,120},{210,220,230}};
			System.out.println(arr13[0][2]);
			
			//int[][] arr14 ;
			//arr14 = {{1,2,3},{4,5,6}} ; : 오류 발생
			
			//6. 다양한 타입의 배열 변수 선언하기
