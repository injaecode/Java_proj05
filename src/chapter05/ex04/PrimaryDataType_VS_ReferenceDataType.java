...
public class PrimaryDataType_VS_ReferenceDataType {
	...
	public static void main(String[] args) {
		...
		int[] arr2 = arr1; 	// Heap영역의 값을 복사하는 것이 아니라 arr1의 Stack 주소를 복사
		arr2[0] = 7;
		...
		System.out.println("==================");
		//객체의 Heap영역의 주소 출력 : String 예외사항 <- 객체를 출력하면 객체의 값이 출력
		System.out.println(arr1); //Heap영역 16진수의 Hash Code <- 메모리 주소값
